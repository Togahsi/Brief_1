...
import java.util.Scanner;
    public class Administrator {
        ...
        private static ArrayList<Student> studentList = new ArrayList<Student>(100);
        ...
        public static void addStudent() {
            ...
            studentArr = new Student[EnterNumber];
            for (int i = 0; i < EnterNumber; i++) {
                studentArr[i] = new Student();
                System.out.println("✨ ✨ ✨ ✨ ✨ ✨ ✨ ✨ ✨ ✨ ✨ ✨ ");
                System.out.println("Enter the \"First Name\" : ");
                studentArr[i].setFirst_Name(cin.next());
                System.out.println("Enter the \"Last Name\": ");
                studentArr[i].setLast_Name(cin.next());
                System.out.println("Enter the \"Date Of Birth\" : ");
                studentArr[i].setDate_of_birth(cin.next());
                System.out.println("Enter the \"Address\" : ");
                studentArr[i].setAddress(cin.next());
                System.out.println("Enter the \"Telephone Number\" : ");
                studentArr[i].setTele_Number(cin.nextDouble());
                System.out.println("Enter the \"Class Number\" : ");
                studentArr[i].setClass_Number(cin.nextInt());
                System.out.println("Enter the \"Id Number\": ");
                studentArr[i].setId_Number(cin.nextInt());
                    ...
                    if (Ob_student.getFirst_Name().equals(StudentName)) {
                        ...
                        switch (choice) {
                            case 1:
                                ...
                                Ob_student.setFirst_Name(newFirstName);
                                break;
                            case 2:
                                System.out.println("Enter new Last Name: ");
                                String newLastName = cin.next();
                                Ob_student.setLast_Name(newLastName);
                                break;
                            case 3:
